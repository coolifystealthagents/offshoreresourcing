---
title: Knowledge-transfer decay in remote support teams
description: Evidence-led research on knowledge transfer in distributed support and operations roles.
...
This report examines knowledge transfer in a defined distributed support or operations role. The unit of analysis is observable work completed during a stated period, not geography as a proxy for capability. The question is which conditions make the role dependable for a defined audience and service promise.

## Finding

Knowledge transfer loses value when treated as a one-time event. Observe a cohort during initial learning and later retrieval, comparing unaided work with work supported by the approved record. Record whether errors arise from missing knowledge, ambiguous policy, or inaccessible context.

---
title: Data minimization for offshore support assignments
description: Evidence-led research on data minimization in distributed support and operations roles.
...
This report examines data minimization in a defined distributed support or operations role. The unit of analysis is observable work completed during a stated period, not geography as a proxy for capability. The question is which conditions make the role dependable for a defined audience and service promise.

## Finding

Data minimization means defining the smallest information and system access needed for a task. Map fields to purpose, retention, approval, and removal. Test masking, aggregation, and time-limited access before granting broader visibility.

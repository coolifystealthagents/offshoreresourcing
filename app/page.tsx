    ...
    <section className="hero-shell">
      ...
      <div className="hero-grid">
        <div className="hero-copy">
          <p className="eyebrow">Resourcing lab</p>
          <h1>Offshore Resourcing: a capacity lab for clearer staffing decisions.</h1>
          <p className="lead">A redesigned offshore resourcing guide for companies building reliable offshore teams across admin, support, finance, and tech. The page now uses a distinct data-driven dashboard layout, industry-specific planning sections, and a conversion path that feels made for this niche.</p>
        ...
        <figure className="hero-media"><img src={site.heroImage || site.serviceImage} alt={site.alt || `${site.brand} planning visual`}/><figcaption>data tiles and resource meters</figcaption></figure>
      </div>
    </section>

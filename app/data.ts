...
const blogPostsSource = [
  { slug: 'philippines-client-success-coordinator-guide', title: 'How to scope a Philippines client success coordinator', excerpt: 'Build a client success support role around account notes, follow-up ownership, renewal signals, and manager-led customer decisions.', minutes: 9, publishedAt: '2026-08-13' },
  { slug: 'philippines-purchasing-assistant-role-scope', title: 'How to scope a Philippines purchasing assistant role', excerpt: 'Separate supplier records, order tracking, and delivery follow-up from vendor selection and purchasing approvals.', minutes: 9, publishedAt: '2026-08-13' },
  { slug: 'philippines-payroll-administration-support', title: 'Philippines payroll administration support boundaries', excerpt: 'Plan careful payroll preparation support with restricted records, deadline checks, and payroll-owner approval.', minutes: 10, publishedAt: '2026-08-13' },
  { slug: 'philippines-insurance-admin-assistant-guide', title: 'How to scope a Philippines insurance administration assistant', excerpt: 'Define policy records, renewal reminders, document follow-up, and decisions that must remain with a licensed adviser.', minutes: 9, publishedAt: '2026-08-13' },
  { slug: 'philippines-sales-development-representative-scope', title: 'How to scope a Philippines sales development representative', excerpt: 'Set prospect research, outreach, qualification, and handoff rules before adding a Philippines SDR.', minutes: 10, publishedAt: '2026-08-13' },
  { slug: 'philippines-claims-processing-support-guide', title: 'Philippines claims processing support guide', excerpt: 'Organize claim intake, document indexing, status updates, and escalation without transferring coverage decisions.', minutes: 9, publishedAt: '2026-08-13' },
  { slug: 'philippines-digital-marketing-coordinator-guide', title: 'How to hire a Philippines digital marketing coordinator', excerpt: 'Test campaign records, asset coordination, analytics preparation, and dependable marketing follow-through.', minutes: 9, publishedAt: '2026-08-13' },
  { slug: 'philippines-operations-analyst-support-scope', title: 'How to scope Philippines operations analyst support', excerpt: 'Define recurring data preparation, exception analysis, and reporting support while leaders retain operating decisions.', minutes: 10, publishedAt: '2026-08-13' },
  { slug: 'philippines-revenue-operations-assistant-guide', title: 'How to hire a Philippines revenue operations assistant', excerpt: 'Build a role around CRM hygiene, handoff records, pipeline reports, and careful sales coordination.', minutes: 9, publishedAt: '2026-08-13' },
  { slug: 'philippines-community-manager-role-scope', title: 'How to scope a Philippines community manager role', excerpt: 'Plan member responses, moderation records, event support, and escalation boundaries for community support.', minutes: 9, publishedAt: '2026-08-13' },
  { slug: 'philippines-website-content-coordinator-guide', title: 'How to hire a Philippines website content coordinator', excerpt: 'Coordinate approved page updates, content records, link checks, and stakeholder follow-up without owning brand decisions.', minutes: 9, publishedAt: '2026-08-13' },
  { slug: 'philippines-technical-project-coordinator-scope', title: 'How to scope a Philippines technical project coordinator', excerpt: 'Use schedules, issue records, meeting notes, and dependency follow-up to support technical projects responsibly.', minutes: 10, publishedAt: '2026-08-13' },
  { slug: 'philippines-procurement-coordinator-hiring-guide', title: 'How to hire a Philippines procurement coordinator', excerpt: 'Test supplier documentation, request tracking, comparison records, and approval discipline for procurement support.', minutes: 9, publishedAt: '2026-08-13' },
  { slug: 'philippines-customer-onboarding-specialist-guide', title: 'How to scope a Philippines customer onboarding specialist', excerpt: 'Map welcome steps, account records, training coordination, and escalation ownership for a smoother customer start.', minutes: 9, publishedAt: '2026-08-13' },
  { slug: 'philippines-virtual-receptionist-intake-guide', title: 'How to scope a Philippines virtual receptionist intake role', excerpt: 'Define call handling, message accuracy, appointment requests, privacy limits, and urgent-call escalation.', minutes: 9, publishedAt: '2026-08-13' },
  { slug: 'philippines-document-control-specialist-guide', title: 'How to hire a Philippines document control specialist', excerpt: 'Set version records, naming rules, access checks, and review reminders for controlled business documents.', minutes: 9, publishedAt: '2026-08-13' },
  { slug: 'philippines-research-assistant-role-scope', title: 'How to scope a Philippines business research assistant', excerpt: 'Separate source discovery, evidence notes, and comparison tables from conclusions and strategic recommendations.', minutes: 9, publishedAt: '2026-08-13' },
  { slug: 'philippines-social-media-coordinator-guide', title: 'How to scope a Philippines social media coordinator', excerpt: 'Organize approved calendars, asset records, community replies, and escalation rules without outsourcing brand judgment.', minutes: 9, publishedAt: '2026-08-13' },
  { slug: 'philippines-facilities-coordinator-hiring-guide', title: 'How to hire a Philippines facilities coordinator', excerpt: 'Coordinate maintenance records, vendor visits, supplies, and issue escalation across distributed workplaces.', minutes: 9, publishedAt: '2026-08-13' },
  { slug: 'philippines-technical-writer-support-guide', title: 'How to scope a Philippines technical writer support role', excerpt: 'Plan documentation interviews, draft maintenance, terminology checks, and subject-matter review boundaries.', minutes: 10, publishedAt: '2026-08-13' },
  { slug: 'philippines-order-management-specialist-guide', title: 'How to hire a Philippines order management specialist', excerpt: 'Define order records, fulfillment follow-up, exception notes, and customer updates for an order support lane.', minutes: 9, publishedAt: '2026-08-13' },
  { slug: 'philippines-appointment-coordinator-role-scope', title: 'How to scope a Philippines appointment coordinator', excerpt: 'Build appointment support around availability checks, reminders, rescheduling, and clear service-owner handoffs.', minutes: 8, publishedAt: '2026-08-13' },

...
const repeatedCareIcon = pageImages.find((tag) => tag.includes('][i]'));
assert.ok(repeatedCareIcon, 'repeated care icon image was not found');
const sharedImages = imageTags(components);
const renderedImages = [...pageImages, repeatedCareIcon, repeatedCareIcon, ...sharedImages, ...sharedImages];
